export const translations = {
  en: {
    ...
    logoOptionsTitle: 'Logo Options',
    logoLabel: 'Add Logo',
    uploadLogo: 'Upload Logo',
    removeLogo: 'Remove Logo',
    dragAndDrop: 'Drag and drop logo here, or click to select',
    sizeLabel: 'Size',
  ...
  es: {
    ...
    logoOptionsTitle: 'Opciones de Logo',
    logoLabel: 'Agregar Logo',
    uploadLogo: 'Subir Logo',
    removeLogo: 'Eliminar Logo',
    dragAndDrop: 'Arrastra y suelta el logo aquí, o haz clic para seleccionar',
    sizeLabel: 'Tamaño',
